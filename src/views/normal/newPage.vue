  ...
  <div>
    <el-form ref="pageForm" :rules="rule" :model="pageObject">
      <el-form-item prop="title">
        <el-input placeholder="标题" v-model="pageObject.title" />
      </el-form-item>
      <el-form-item prop="tags">
        <el-select
          ...
          @change="selectChange"
        >
          <el-option v-for="(name, index) in tagList" :value="name" :key="index" />
        </el-select>
      </el-form-item>
    ...
    <Modal v-model="tagModal" title="创建标签">
      <Form ref="tagForm" :model="tag_obj" :rules="tagRule">
        ...
        <FormItem prop="description">
          <Input v-model="tag_obj.description" type="textarea" placeholder="输入对标签的描述" />
        </FormItem>
      </Form>
      <div slot="footer">
